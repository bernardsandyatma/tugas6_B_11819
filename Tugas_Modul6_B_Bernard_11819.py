...
model = load_model(r"D:\1 tugas kuliah\sem5\ML\Tugas6_B_11819\gugelnet.h5")
...
st.title("Prediksi Kematangan Buah Naga - 1819")
    ...
    if uploaded_files:
        ...
        for uploaded_file in uploaded_files:
            ...
            if label != "Error":
                ...
                st.sidebar.markdown(f"<h4 style='color: {label_color};'>{label}</h4>", unsafe_allow_html=True)
